...
export const NEW_PROJECT_DEFINITIONS = [
  ...
  { card: project("", "丸木小屋", 6, { 木材: 3 }, "coins", 1, "コイン +1"), copies: 3 },
  { card: project("", "光ファイバー通信", 1, { 銅線: 3 }, "gainMaterial", 1, "超伝導体を1枚獲得", false, "超伝導体"), copies: 2 },
...
const createDeck = (state: RoomGameState, playerCount: number) => {
  ...
  const plans: { card: ProjectCard; copies: number }[] = [
    { card: project("", "仮設許可", 1, {}, "coins", 2, "コイン +2", true), copies: 3 },
    { card: project("", "再調達指示", 0, {}, "draw", 2, "カードを2枚引く", true), copies: 3 },
    { card: project("", "工程最適化", 1, {}, "pointBoost", 2, "最終ポイント +2", true), copies: 2 },
    { card: project("", "市場規制", 1, {}, "stealCoins", 2, "指定会社から最大2コイン徴収", true), copies: 2 },
    { card: project("", "抜き打ち検品", 1, {}, "stealCard", 1, "ランダムな他社から手札1枚を奪う", true), copies: 2 },
    { card: project("", "資材差押通知", 1, {}, "discard", 1, "指定会社の手札を1枚破棄", true), copies: 2 },
    { card: project("", "緊急木材調達", 0, {}, "gainMaterial", 2, "木材を2枚獲得", true, "木材"), copies: 2 },
    { card: project("", "鉄骨優先供給", 0, {}, "gainMaterial", 2, "鉄骨を2枚獲得", true, "鉄骨"), copies: 2 },
    { card: project("", "基礎資材配給", 0, {}, "gainMaterial", 2, "コンクリートを2枚獲得", true, "コンクリート"), copies: 2 },
    { card: project("", "ガラス緊急搬入", 0, {}, "gainMaterial", 2, "ガラスを2枚獲得", true, "ガラス"), copies: 2 },
    { card: project("", "配線先行確保", 0, {}, "gainMaterial", 2, "銅線を2枚獲得", true, "銅線"), copies: 2 },
    { card: project("", "市民ホール", 5, { 木材: 2, 鉄骨: 1 }, "coins", 4, "コイン +4"), copies: 3 },
    { card: project("", "集合住宅群", 4, { 木材: 2, コンクリート: 1 }, "draw", 2, "カードを2枚引く"), copies: 3 },
    { card: project("", "再開発タワー", 7, { 鉄骨: 2, コンクリート: 1 }, "coins", 5, "コイン +5"), copies: 2 },
    { card: project("", "浮遊温室", 6, { 木材: 1, ガラス: 2, 銅線: 1 }, "coins", 4, "コイン +4"), copies: 2 },
    { card: project("", "高速架橋", 8, { 鉄骨: 2, コンクリート: 2 }, "draw", 3, "カードを3枚引く"), copies: 2 },
    { card: project("", "地下市場", 7, { コンクリート: 2, 銅線: 2 }, "coins", 5, "コイン +5"), copies: 2 },
    { card: project("", "ガラス劇場", 6, { 鉄骨: 1, ガラス: 2, 木材: 1 }, "coins", 4, "コイン +4"), copies: 2 },
    { card: project("", "強制施工監査", 5, { 鉄骨: 2, 銅線: 1 }, "forceBulk", 1, "強制BALKUを1回獲得"), copies: 3 },
    { card: project("", "品質保証局", 5, { 木材: 1, ガラス: 2 }, "pointBoost", 3, "最終ポイント +3"), copies: 2 },
    { card: project("", "資金凍結令", 4, { 銅線: 2, コンクリート: 1 }, "stealCoins", 3, "指定会社から最大3コイン徴収"), copies: 2 },
    ...
    { card: project("", "地区電力網", 6, { 銅線: 2, 合金: 1, コンクリート: 1 }, "income", 1, "毎ターン開始時 コイン +1"), copies: 3 },
