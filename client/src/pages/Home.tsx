...
function Tutorial({ onClose }: { onClose: () => void }) {
  ...
  const slides = [{ eyebrow: "01 / 入室", title: "名前を記入して、\n同じ現場へ入る。", body: "ルームコードを入力すると、同じ盤面に参加できます。" }, { eyebrow: "02 / 施工", title: "企画を置き、\n素材を納める。", body: "企画を選ぶと施工ポケットが開きます。素材はドラッグまたはタップで納品できます。" }, { eyebrow: "03 / 市場", title: "ショップと競りを\n使い分ける。", body: "ショップは右上から開けます。共通市場の入札は全員に開かれています。" }, { eyebrow: "04 / 検査", title: "伏せた企画を\nBALKUする。", body: "未解決の他社企画だけを検査できます。すでに解決した企画には操作は出ません。" }, { eyebrow: "05 / 精算", title: "山札が尽きれば、\n最終精算。", body: "残り10枚から終盤警告。提出企画とバフの合計で勝者が決まります。" }];
